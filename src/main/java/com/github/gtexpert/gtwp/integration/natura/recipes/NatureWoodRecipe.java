        ...
        if (DEFAULT_ENTRIES == null) {
            return DEFAULT_ENTRIES = Arrays.asList(
                    ...
                    new WoodTypeEntry.Builder(mcModId, "maple")
                            ...
                            .fenceGate(Mods.Natura.getItem("maple_fence_gate"), "decorative/overworld/fence_gate/maple_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "silverbell")
                            ...
                            .stairs(Mods.Natura.getItem("overworld_stairs_silverbell"), "overworld/stairs/silverbell_stairs")
                            .fenceGate(Mods.Natura.getItem("silverbell_fence_gate"), "decorative/overworld/fence_gate/silverbell_fence_gate")
                            .fence(Mods.Natura.getItem("silverbell_fence"), "decorative/overworld/fence/silverbell_fence")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "amaranth")
                            ...
                            .stairs(Mods.Natura.getItem("overworld_stairs_amaranth"), "overworld/stairs/amaranth_stairs")
                            .fenceGate(Mods.Natura.getItem("amaranth_fence_gate"), "decorative/overworld/fence_gate/amaranth_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "tiger")
                            ...
                            .fenceGate(Mods.Natura.getItem("tiger_fence_gate"), "decorative/overworld/fence_gate/tiger_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "willow")
                            ...
                            .fenceGate(Mods.Natura.getItem("willow_fence_gate"), "decorative/overworld/fence_gate/willow_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "eucalyptus")
                            ...
                            .stairs(Mods.Natura.getItem("overworld_stairs_eucalyptus"), "overworld/stairs/eucalyptus_stairs")
                            .fenceGate(Mods.Natura.getItem("eucalyptus_fence_gate"), "decorative/overworld/fence_gate/eucalyptus_fence_gate")
                            .fence(Mods.Natura.getItem("eucalyptus_fence"), "decorative/overworld/fence/eucalyptus_fence")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "hopseed")
                            ...
                            .fenceGate(Mods.Natura.getItem("hopseed_fence_gate"), "decorative/overworld/fence_gate/hopseed_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "sakura")
                            ...
                            .fenceGate(Mods.Natura.getItem("sakura_fence_gate"), "decorative/overworld/fence_gate/sakura_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "redwood")
                            ...
                            .fenceGate(Mods.Natura.getItem("redwood_fence_gate"), "decorative/overworld/fence_gate/redwood_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "ghostwood")
                            ...
                            .fenceGate(Mods.Natura.getItem("ghostwood_fence_gate"), "decorative/nether/fence_gate/ghostwood_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "darkwood")
                            ...
                            .fenceGate(Mods.Natura.getItem("darkwood_fence_gate"), "decorative/nether/fence_gate/darkwood_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "fusewood")
                            ...
                            .fenceGate(Mods.Natura.getItem("fusewood_fence_gate"), "decorative/nether/fence_gate/fusewood_fence_gate")
                    ...
                    new WoodTypeEntry.Builder(mcModId, "bloodwood")
                            ...
                            .fenceGate(Mods.Natura.getItem("bloodwood_fence_gate"), "decorative/nether/fence_gate/bloodwood_fence_gate")
        ...
        for (WoodTypeEntry entry : getDefaultEntries()) {
            if (woodMetaMap.containsKey(entry.woodName)) {
                ...
                if (!entry.woodName.equals("ghostwood") && !entry.woodName.equals("bloodwood") &&
                    ...
                    ModHandler.addMirroredShapedRecipe(entry.woodName + "_stick_normal", GTUtility.copy(stick_normal, Stick), "P ", " P",
                            'P', entry.planks);
                    ModHandler.addMirroredShapedRecipe(entry.woodName + "_stick_saw", GTUtility.copy(stick_saw, Stick), "Ps", " P",
                            'P', entry.planks);
